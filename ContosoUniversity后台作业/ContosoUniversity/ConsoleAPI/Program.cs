...
namespace ConsoleAPI
{
    class Program
    {
        ...
        {
            string appkey = "9f30d07df37a5d4c06df87cdc9fb3716"; //配置您申请的appkey
            ...
            parameters1.Add("cityname", "北京"); //城市名或城市ID，如：&quot;苏州&quot;，需要utf8 urlencode
            parameters1.Add("dtype", "json"); //返回数据格式：json或xml,默认json
            parameters1.Add("format", "2"); //未来6天预报(future)两种返回格式，1或2，默认1
            ...
            parameters3.Add("ip", "柳州"); //ip地址，如：58.215.185.154
            parameters3.Add("dtype", "json"); //返回数据格式：json或xml,默认json
            parameters3.Add("format", "1"); //未来6天预报(future)两种返回格式，1或2，默认1
